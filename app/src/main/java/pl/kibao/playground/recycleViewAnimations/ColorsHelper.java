...
public class ColorsHelper {
    ...
    private static final int colorsSize;
    ...
    static {
        ...
        colorsSize = hexColors.length;

        Integer[] colors = new Integer[hexColors.length];
    ...
    public static Integer generateColor() {
        return COLORS.get(new Random().nextInt(colorsSize));
    }
    ...
    public static Integer getTextColor(Integer backgroundColor) {
